...
<div class="row justify-content-center">
    <div class="col-12 col-md-8 col-lg-6">
        ...
        <div class="d-flex align-items-center mb-4">
            ...
            <h4 class="fw-bold mb-0">Crear Nuevo Canal</h4>
        </div>
        ...
        <div class="card p-4 shadow-sm border-0" style="border-radius:12px;">
            <form action="{{ route('canales.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror" value="{{ old('nombre') }}" required maxlength="150" placeholder="Ej. Matemáticas Avanzadas">
                    @error('nombre')
                ...
                <div class="mb-4">
                    ...
                    <textarea name="descripcion" class="form-control @error('descripcion') is-invalid @enderror" rows="4" maxlength="300" placeholder="Breve descripción del contenido del canal...">{{ old('descripcion') }}</textarea>
                    @error('descripcion')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <button type="submit" class="btn w-100 text-white" style="background-color:#378ADD; border-radius: 8px;">
                    <i class="bi bi-check-circle me-1"></i> Guardar Canal
                </button>
            </form>
        </div>
